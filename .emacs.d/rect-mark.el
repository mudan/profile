...
;;; 直观地把矩形显示出来。例如，上面的这个区域，使用 rect-mark.el 的 rm-exchange-point-and-mark 命令 (作为和绑定到 C-x C-x 的 exchange-point-and-mark 对应起来，我们可以把他绑定到 C-x r C-x 上)把他变成一个直观的矩形区域
