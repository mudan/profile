...
#全部历史纪录 top50
function top50 { allhistory | awk -F':[ 0-9]*:[0-9]*;' '{ $1="" ; print }' | sed 
...
zstyle ':completion:*' completer _complete _prefix _correct _prefix _match 
_approximate
...
# 进程名补全
zstyle ':completion:*:processes-names' command  'ps c -u ${}&lt;ESC>iUSER&lt;c-r>=ClosePair('}')&lt;CR> -o command | uniq'''''''''''''''
